...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof float16ToFloat32, 'function', 'main export is a function' );
	t.end();
});

tape( 'if provided `0`, the function returns `0`', opts, function test( t ) {
	var v = float16ToFloat32( 0.0 );
...
tape( 'if provided `+infinity`, the function returns `+infinity`', opts, function test( t ) {
	var v = float16ToFloat32( PINF );
	t.strictEqual( v, PINF, 'returns expected value' );
	t.end();
});

tape( 'if provided `-infinity`, the function returns `-infinity`', opts, function test( t ) {
	var v = float16ToFloat32( NINF );
	t.strictEqual( v, NINF, 'returns expected value' );
	t.end();
});

tape( 'if provided `NaN`, the function returns `NaN`', opts, function test( t ) {
	var v = float16ToFloat32( NaN );
	t.strictEqual( isnanf( v ), true, 'returns expected value' );
	t.end();
});

tape( 'the function returns the nearest single-precision floating-point number (+large values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
	...
	for ( i = 0; i < x.length; i++ ) {
		y = float16ToFloat32( float64ToFloat16( x[ i ] ) );
		t.strictEqual( y, expected[ i ], 'y: '+y+', expected: '+expected[ i ] );
	}
	t.end();
});

tape( 'the function returns the nearest single-precision floating-point number (+normal values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function returns the nearest single-precision floating-point number (+small values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function returns the nearest single-precision floating-point number (+tiny values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function returns the nearest single-precision floating-point number (+subnormal values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
